...
class EquityConnector:
    ...
    def recommendation_trends(self, symbol):
        ...
        raise AssertionError("recommendation enrichment must remain outside the valuation scenario builder")
...
def test_equity_ready_when_consensus_is_fresh_and_fundamentals_are_attached():
