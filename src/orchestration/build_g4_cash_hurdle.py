...
def _dynamic_equity_margin(result,reviewed,raw_policy):
    ...
    cfg=raw_policy.get('dynamic_equity_margin',{}) or {}; base=float(cfg.get('base_equity_risk_buffer',0.)); unc_max=float(cfg.get('uncertainty_buffer_max',0.)); downside_max=float(cfg.get('downside_buffer_max',0.))
